...
GPIO_Init(KS0108_PORT_D, &GPIO_InitStructure);
...
GLCD_Delay();
status = ((GPIO_ReadInputData(KS0108_PORT_D) >> KS0108_D0) & 0xFF);
...
GLCD_EnableController(controller);
GLCD_Delay();
GPIO_SetBits(KS0108_PORT_D, (commandToWrite << KS0108_D0));
commandToWrite ^= 0xFF;
GPIO_ResetBits(KS0108_PORT_D, (commandToWrite << KS0108_D0));
GLCD_Delay();
GPIO_SetBits(KS0108_PORT, KS0108_EN);
GLCD_Delay();
GPIO_ResetBits(KS0108_PORT, KS0108_EN);
...
GPIO_SetBits(KS0108_PORT, KS0108_EN);
GLCD_Delay();
tmp = ((GPIO_ReadInputData(KS0108_PORT_D) >> KS0108_D0) & 0xFF);
GPIO_ResetBits(KS0108_PORT, KS0108_EN);
...
GLCD_Delay();
GPIO_SetBits(KS0108_PORT_D, (dataToWrite << KS0108_D0));
dataToWrite ^= 0xFF;
GPIO_ResetBits(KS0108_PORT_D, (dataToWrite << KS0108_D0));
GLCD_Delay();
GLCD_EnableController(screen_x / 64);
GLCD_Delay();
GPIO_SetBits(KS0108_PORT, KS0108_EN);
